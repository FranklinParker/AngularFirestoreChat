...
export const getPrivateMessagesArchived = createSelector( getChatState , fromChat.getPrivateMessagesArchived);
export const getPrivateMessagesNew = createSelector( getChatState , fromChat.getPrivateMessagesNew);
